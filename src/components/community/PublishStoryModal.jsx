...
export default function PublishStoryModal({ story, onClose, onPublish }) {
    ...
    const { activeChild } = useProfile(); // Use the profile from context

    const missingEmail = !activeChild?.parent_email;
    ...
    const handleSubmit = async () => {
        ...
        // Pass the full child profile age to the publish function
        await onPublish(story, { authorName, consentGiven, authorAge: activeChild.age });
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-blue-700">
                                    ...
                                    Hvis historien vinder, kontakter vi dig på {activeChild?.parent_email || 'den registrerede email'} 
