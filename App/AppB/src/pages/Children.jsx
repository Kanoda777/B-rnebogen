...
const handleChildCreated = async () => {
  ...
  const updatedChildren = await Child.list("-created_date");
  if (updatedChildren.length > 0) {
    const latestChild = updatedChildren[0];
    console.log("Setting active child_id in localStorage:", latestChild.id);
    localStorage.setItem("child_id", latestChild.id);
  }
};
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Indlæser børneprofiler...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
              Opret en profil for hvert barn for at personalisere deres historier
            </p>
